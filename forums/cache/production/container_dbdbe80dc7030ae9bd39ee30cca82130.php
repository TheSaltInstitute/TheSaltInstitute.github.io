...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'phpbb2_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../', 'php', 'phpbb2_forums', 'phpbb2_posts', 'phpbb2_topics', 'phpbb2_users');
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'phpbb2_ext', './../', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'phpbb2_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './../', 'php', 'phpbb2_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_bbcodes', 'phpbb2_smilies', 'phpbb2_styles', 'phpbb2_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'phpbb2_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'phpbb2_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.notification_emails' => 'phpbb2_notification_emails',
            ...
            'tables' => [
                'acl_groups' => 'phpbb2_acl_groups',
                'acl_options' => 'phpbb2_acl_options',
                'acl_roles' => 'phpbb2_acl_roles',
                'acl_roles_data' => 'phpbb2_acl_roles_data',
                'acl_users' => 'phpbb2_acl_users',
                'attachments' => 'phpbb2_attachments',
                'auth_provider_oauth_token_storage' => 'phpbb2_oauth_tokens',
                'auth_provider_oauth_states' => 'phpbb2_oauth_states',
                'auth_provider_oauth_account_assoc' => 'phpbb2_oauth_accounts',
                'banlist' => 'phpbb2_banlist',
                'bbcodes' => 'phpbb2_bbcodes',
                'bookmarks' => 'phpbb2_bookmarks',
                'bots' => 'phpbb2_bots',
                'captcha_qa_questions' => 'phpbb2_captcha_questions',
                'captcha_qa_answers' => 'phpbb2_captcha_answers',
                'captcha_qa_confirm' => 'phpbb2_qa_confirm',
                'config' => 'phpbb2_config',
                'config_text' => 'phpbb2_config_text',
                'confirm' => 'phpbb2_confirm',
                'disallow' => 'phpbb2_disallow',
                'drafts' => 'phpbb2_drafts',
                'ext' => 'phpbb2_ext',
                'extensions' => 'phpbb2_extensions',
                'extension_groups' => 'phpbb2_extension_groups',
                'forums' => 'phpbb2_forums',
                'forums_access' => 'phpbb2_forums_access',
                'forums_track' => 'phpbb2_forums_track',
                'forums_watch' => 'phpbb2_forums_watch',
                'groups' => 'phpbb2_groups',
                'icons' => 'phpbb2_icons',
                'lang' => 'phpbb2_lang',
                'log' => 'phpbb2_log',
                'login_attempts' => 'phpbb2_login_attempts',
                'migrations' => 'phpbb2_migrations',
                'moderator_cache' => 'phpbb2_moderator_cache',
                'modules' => 'phpbb2_modules',
                'notification_emails' => 'phpbb2_notification_emails',
                'notification_types' => 'phpbb2_notification_types',
                'notifications' => 'phpbb2_notifications',
                'poll_options' => 'phpbb2_poll_options',
                'poll_votes' => 'phpbb2_poll_votes',
                'posts' => 'phpbb2_posts',
                'privmsgs' => 'phpbb2_privmsgs',
                'privmsgs_folder' => 'phpbb2_privmsgs_folder',
                'privmsgs_rules' => 'phpbb2_privmsgs_rules',
                'privmsgs_to' => 'phpbb2_privmsgs_to',
                'profile_fields' => 'phpbb2_profile_fields',
                'profile_fields_data' => 'phpbb2_profile_fields_data',
                'profile_fields_options_language' => 'phpbb2_profile_fields_lang',
                'profile_fields_language' => 'phpbb2_profile_lang',
                'ranks' => 'phpbb2_ranks',
                'reports' => 'phpbb2_reports',
                'reports_reasons' => 'phpbb2_reports_reasons',
                'search_results' => 'phpbb2_search_results',
                'search_wordlist' => 'phpbb2_search_wordlist',
                'search_wordmatch' => 'phpbb2_search_wordmatch',
                'sessions' => 'phpbb2_sessions',
                'sessions_keys' => 'phpbb2_sessions_keys',
                'sitelist' => 'phpbb2_sitelist',
                'smilies' => 'phpbb2_smilies',
                'sphinx' => 'phpbb2_sphinx',
                'styles' => 'phpbb2_styles',
                'styles_template' => 'phpbb2_styles_template',
                'styles_template_data' => 'phpbb2_styles_template_data',
                'styles_theme' => 'phpbb2_styles_theme',
                'styles_imageset' => 'phpbb2_styles_imageset',
                'styles_imageset_data' => 'phpbb2_styles_imageset_data',
                'teampage' => 'phpbb2_teampage',
                'topics' => 'phpbb2_topics',
                'topics_posted' => 'phpbb2_topics_posted',
                'topics_track' => 'phpbb2_topics_track',
                'topics_watch' => 'phpbb2_topics_watch',
                'user_group' => 'phpbb2_user_group',
                'user_notifications' => 'phpbb2_user_notifications',
                'users' => 'phpbb2_users',
                'warnings' => 'phpbb2_warnings',
                'words' => 'phpbb2_words',
                'zebra' => 'phpbb2_zebra',
            ],
